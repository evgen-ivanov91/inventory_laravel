        ...
        <div class="row">
            <div class="col-6">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label for="InputOther" class="form-label">Совместимость</label>
                        <input type="text" class="form-control" id="InputOther" v-model="compatibility" placeholder=" ">
                    </div>
...
//model	invNum	serialNum	compatibility	take	fueled	issued	client_id
    ...
    methods:{
        ...
        store(){
            ...
            console.log(data)
            this.$store.dispatch('ajaxSetCartridgeToDB', data )
        }
    },
    computed: {
        Clients() {
